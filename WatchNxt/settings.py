"""
Django settings for WatchNxt project.
...
SECRET_KEY = 'django-insecure-v78fqbw5j9+k!-@i5mhrzj#33mqt&2kg!tm5d@mb0*okuunde@'
...
WSGI_APPLICATION = 'WatchNxt.wsgi.application'
